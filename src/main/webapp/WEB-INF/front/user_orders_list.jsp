				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/product-list?category_id=9">Жіноче</a>
						</li>
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/product-list?category_id=10">Чоловіче</a>
						</li>
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/product-list?category_id=11">Дітяче</a>
						</li>
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/product-list?category_id=12">Сумки</a>
						</li>
					</ul>
				</div>
			</div>
		    ...
		    <div class="col-8 offset-2">
		        ...
		        <c:if test="${orders.size() > 0 }">
					...
					<tbody class="table-striped">
						...
						<tr scope="row">
							<td>${order.orderId }</td>
							<td><fmt:formatDate value="${order.orderDate}" type="date" pattern="dd-MMM-yyyy"/></td>
							<td>
