...
<body>
	...
	<div class="container">
	    ...
	    <c:if test="${products.size()>0 }">
	        ...
	        <div class="col-3  p-2">
	              <div class="row mx-1 shadow-sm border">
	                   <div class="col-12">
	                   ...
	                   <div class="row py-1">
	                   	<div class="col-6"><a class="btn btn-success" href="view-produst?product_id=${product.id}">View</a></div>
	                   	<div class="col-6"><a class="btn btn-secondary" href="view-cart?action=add&product_id=${product.id}">Add to cart</a></div>
	                   </div>	                   
	                  </div>
	              </div>
	        </div>
