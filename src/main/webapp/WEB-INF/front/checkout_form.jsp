...
<body>
	...
	<div class="container">
		...
		<div class="col-8 offset-2 py-4"></div>
				...
				<c:choose>
					<c:when test="${ errorMessages == null }">
						<form method="post" action="checkout"
							...
							<div class="col-12">
								<label for="type" class="form-label">Shipping address:</label> <input
									type="text" class="form-control" id="shipping_address" name="shipping_address"
									value="43, Independence Str., Lviv, Ukraine" required>
								<div class="invalid-feedback">Please provide a valid
									Shipping address.</div>
							</div>
							<div class="col-6">
								<label for="brand" class="form-label">Recipient Name:</label> <input
									type="text" class="form-control" id="recipient_name" name="recipient_name"
									value="Bogdan Frankiv" required>
								<div class="invalid-feedback">Please provide a valid
									Recipient Name:.</div>
							</div>
							<div class="col-6">
								<label for="model" class="form-label">Recipient Phone:</label> <input
									type="text" class="form-control" id="recipient_phone" name="recipient_phone"
									value="+380 67 100 50 50" required>
								<div class="invalid-feedback">Please provide a valid
									Recipient Phone.</div>
							</div>
							...
							<div class="col-6">
								...
								<select
									class="form-select" id="payment_method" name="payment_method" required>
